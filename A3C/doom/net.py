...
class Net(object):
    def __init__(self, s_dim, a_dim, scope, trainer):
        ...
        with tf.variable_scope(self.scope):
            ...
            inputs = tf.reshape(self.inputs, [-1, 84, 84, 1]) # reshape
    ...
    def _update_network(self, trainer):
        ...
        self.actions_onehot = tf.one_hot(self.actions, self.a_dim, dtype=tf.float32)
        ...
        self.policy_loss = -tf.reduce_sum(tf.log(self.outputs) * self.advantages)
